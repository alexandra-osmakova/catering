<?php
$url = (!isset($_POST["location"]) || $_POST["location"] === "") ? "/" : "docs/" . $_POST["location"] . ".pdf";
...
<style>
    ...
    #zay-modal-overlay h3, #zay-allowed-modal-overlay h3, #zay-menu-overlay h3 {
        font-size: 24px;
        font-weight: 600;
        position: relative;
    }

    #zay-modal-overlay h3:after, #zay-allowed-modal-overlay h3:after, #zay-menu-overlay h3:after {
        content: "";
        position: absolute;
        width: 20%;
        height: 5px;
    ...
    #zay-modal-overlay h4, #zay-allowed-modal-overlay h4, #zay-menu-overlay h4 {
        font-size: 14px;
        margin-top: 40px;
    }
    ...
    .zay-allowed-modal-container svg {
        width: 80px;
    }
